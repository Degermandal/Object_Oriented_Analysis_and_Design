...
public class EUSmartPhoneStore extends SmartPhoneStore {
    ...
    protected SmartPhone createSmartPhone(String item) {
        ...
        SmartPhoneComponentFactory compFactory = new EUSmartPhoneComponentFactory();

        if (item.equals("MaximumEffort")) {
            sp = new MaximumEffortSP(compFactory);
            sp.setModel("EU Style MaximumEffort SmartPhone");

        } else if (item.equals("IflasDeluxe")) {
            sp = new IflasDeluxeSP(compFactory);
            sp.setModel("EU Style IflasDeluxe SmartPhone");

        } else if (item.equals("I_I_Aman_Iflas")) {
            sp = new I_I_Aman_IflasSP(compFactory);
            sp.setModel("EU Style I-I-Aman-Iflas SmartPhone");

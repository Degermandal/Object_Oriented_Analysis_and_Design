...
public class UpdateCommandIncrease implements Command{
     ...
     */
    public UpdateCommandIncrease(Transaction trans) {
        this.trans = trans;
    }
    ...
    public void execute() {
        trans.increase();
        System.out.println("Done increase transaction and Update Table => " +
    ...
    public void undo() {
        trans.decrease();
        System.out.println("Done increaseUndo transaction and Update Table => " +
                "account: " + trans.getAccount() + " amount: " + trans.getAmount());
    ...
    public void store() {
        ...
        System.out.println("TransStoreIncreaseUpdate: " + "Account: " +trans.getAccount() + "  Amount: " + trans.getAmount());
    }
    ...
    public void load() {
        ...
        System.out.println("TransLoadIncreaseUpdate: " + "Account: " +transLoad.getAccount() + "  Amount: " + transLoad.getAmount());
    }
}

...
public class UpdateCommandDecrease implements  Command{
     ...
     */
    public UpdateCommandDecrease(Transaction trans) {
        this.trans = trans;
    }
    ...
    public void execute() {
        trans.decrease();
        System.out.println("Done decrease transaction and Update Table => " +
    ...
    public void undo() {
        trans.increase();
        System.out.println("Done decreaseUndo transaction and Update Table => " +
                "account: " + trans.getAccount() + " amount: " + trans.getAmount());
    ...
    public void store() {
        ...
        System.out.println("TransStoreDecreaseUpdate: " + "Account: " +trans.getAccount() + "  Amount: " + trans.getAmount());
    }
    ...
    public void load() {
        ...
        System.out.println("TransLoadDecreaseUpdate: " + "Account: " +transLoad.getAccount() + "  Amount: " + transLoad.getAmount());
    }
}
